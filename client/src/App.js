...
const API_URL =
  ...
  'https://localhost:5000/api/v1/messages' :
  'production-url-here';

class App extends Component {
  state = {
    location: {
      // set default map position to be london
      lat: 51.505,
      lng: -0.09
    },
      ...
      for stopping by! < /CardText> {
        !this.state.sendingMessage &&
          ...
          this.state.haveUsersLocation ? ( <
            ...
            <
            Label
            for = "exampleMessage" > Message < /Label> <
            Input onChange = {
              this.valueChanged
            }
            type = "textarea"
            ...
            CardText > Thanks
            for submitting a message! < /CardText>
          )
      } <
      /Card> <
      /div>
